...
class RealtimeUpdateWorker(QThread):
    ...
    def do_check(self):
        try:
            url = f"https://raw.githubusercontent.com/happybetatest/LOGO/main/version.json?t={int(time.time())}"
    ...
    def do_download(self):
        try:
            files_to_sync = [
                ("gui_macro.py", "https://raw.githubusercontent.com/happybetatest/LOGO/main/gui_macro.py"),
                ("keyauth_helper.py", "https://raw.githubusercontent.com/happybetatest/LOGO/main/keyauth_helper.py"),
                ("discord_remote.py", "https://raw.githubusercontent.com/happybetatest/LOGO/main/discord_remote.py"),
                ("version.json", "https://raw.githubusercontent.com/happybetatest/LOGO/main/version.json")
            ]
...
def check_license_or_prompt():
    ...
    try:
        ...
        def get_key_storage_path():
            ...
            app_name = "LOGO-Farming-Beta" if "Beta" in cwd or "beta" in cwd else "LOGO-Farming"
...
if __name__ == "__main__":
    ...
    window = MainWindow()
    if expiry:
        window.setWindowTitle(f"LOGO Farming - Macro (หมดอายุ: {expiry})")
    window.show()
