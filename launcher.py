...
PACKAGE_ASSET = "LOGO-Package.zip"
APP_EXE = "LOGO-Macro.exe"
APP_DIR = os.path.join(os.environ.get("LOCALAPPDATA", os.path.expanduser("~")), "LOGO-Farming")
VERSION_FILE = os.path.join(APP_DIR, ".installed-version.json")
USER_AGENT = "LOGO-Launcher/1.0"
...
class LauncherWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("LOGO Launcher")
