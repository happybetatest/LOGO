...
REPOSITORY = "happybetatest/LOGO"
RELEASES_API = f"https://api.github.com/repos/{REPOSITORY}/releases"
LATEST_RELEASE_API = f"https://api.github.com/repos/{REPOSITORY}/releases/latest"
MANIFEST_ASSET = "beta-manifest.json"
PACKAGE_ASSET = "LOGO-Beta-Package.zip"
APP_EXE = "LOGO-Beta-Macro.exe"
APP_DIR = os.path.join(os.environ.get("LOCALAPPDATA", os.path.expanduser("~")), "LOGO-Farming-Beta")
VERSION_FILE = os.path.join(APP_DIR, ".installed-version.json")
USER_AGENT = "LOGO-Beta-Launcher/1.0"
...
class LauncherWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("LOGO Launcher (Beta Channel)")
        ...
        self.title_label = QLabel("กำลังตรวจสอบเวอร์ชันล่าสุด (Beta)…")
